...
const translations: Record<string, Record<Language, string>> = {
  ...
  "home.viewResume": { en: "View Resume", ar: "السيرة الذاتية" },
  ...
  "home.certificates": { en: "Certificates", ar: "الشهـادات" },
  "home.certificatesDesc": { en: "Official certifications and academic achievements.", ar: "الشهادات الرسمية والإنجازات الأكاديمية." },
  "home.viewPdf": { en: "View PDF", ar: "عرض ملف PDF" },
  "home.viewCredential": { en: "View Credential", ar: "عرض الشهادة" },
